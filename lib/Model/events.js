...
Model.prototype.wrapCallback = function(cb) { console.log('Model.wrapCallback');
...
Model.prototype._emitError = function(err, context) { console.log('Model._emitError');
...
Model.prototype.emit = function(type) { console.log('Model.emit');
  if (type === 'error') {
...
Model.prototype.on = function(type, pattern, cb) { console.log('Model.on');
  var listener = eventListener(this, pattern, cb);
  this._on(type, listener);
  return listener;
};

Model.prototype.once = function(type, pattern, cb) { console.log('Model.once');
  var listener = eventListener(this, pattern, cb);
  function g() {
...
Model.prototype.removeAllListeners = function(type, subpattern) { console.log('Model.removeAllListeners');
...
Model.prototype.pass = function(object, invert) { console.log('Model.pass');
 ...
 * @return {Model}
 */
Model.prototype.silent = function(value) { console.log('Model.silent');
  var model = this._child();
  model._silent = (value == null) ? true : value;
  return model;
};

Model.prototype.eventContext = function(value) { console.log('Model.eventContext');
  var model = this._child();
  model._eventContext = value;
  return model;
};

Model.prototype.removeContextListeners = function(value) { console.log('Model.removeContextListeners');
  if (arguments.length === 0) {
