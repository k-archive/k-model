...
Model.prototype._mutate = function(segments, fn, cb) { console.log('Model._mutate');
...
Model.prototype.set = function() { console.log('Model.set');
...
Model.prototype._set = function(segments, value, cb) { console.log('Model._set');
...
Model.prototype.setNull = function() { console.log('Model.setNull');
  var subpath, value, cb;
  if (arguments.length === 1) {
    value = arguments[0];
  } else if (arguments.length === 2) {
...
Model.prototype._setNull = function(segments, value, cb) { console.log('Model._setNull');
  segments = this._dereference(segments);
  var model = this;
...
Model.prototype.setEach = function() { console.log('Model.setEach');
...
Model.prototype._setEach = function(segments, object, cb) { console.log('Model._setEach');
  segments = this._dereference(segments);
...
Model.prototype.create = function() { console.log('Model.create');
  var subpath, value, cb;
...
Model.prototype._create = function(segments, value, cb) { console.log('Model._create');
  segments = this._dereference(segments);
...
Model.prototype.createNull = function() { console.log('Model.createNull');
  var subpath, value, cb;
  if (arguments.length === 0) {
    value = {};
  } else if (arguments.length === 1) {
...
Model.prototype._createNull = function(segments, value, cb) { console.log('Model._createNull');
  segments = this._dereference(segments);
...
Model.prototype.add = function() { console.log('Model.add');
  var subpath, value, cb;
  if (arguments.length === 0) {
    value = {};
  } else if (arguments.length === 1) {
...
Model.prototype._add = function(segments, value, cb) { console.log('Model._add');
...
Model.prototype.del = function() { console.log('Model.del');
  var subpath, cb;
  if (arguments.length === 1) {
    if (typeof arguments[0] === 'function') {
      cb = arguments[0];
...
Model.prototype._del = function(segments, cb) { console.log('Model._del');
  segments = this._dereference(segments);
  var model = this;
...
Model.prototype.increment = function() { console.log('Model.increment');
...
Model.prototype._increment = function(segments, byNumber, cb) { console.log('Model._increment');
  segments = this._dereference(segments);
...
Model.prototype.push = function() { console.log('Model.push');
  var subpath, value, cb;
  if (arguments.length === 1) {
    value = arguments[0];
  } else if (arguments.length === 2) {
...
Model.prototype._push = function(segments, value, cb) { console.log('Model._push');
...
Model.prototype.unshift = function() { console.log('Model.unshift');
  var subpath, value, cb;
  if (arguments.length === 1) {
    value = arguments[0];
  } else if (arguments.length === 2) {
...
Model.prototype._unshift = function(segments, value, cb) { console.log('Model._unshift');
  var forArrayMutator = true;
  segments = this._dereference(segments, forArrayMutator);
  var model = this;
...
Model.prototype.insert = function() { console.log('Model.insert');
...
Model.prototype._insert = function(segments, index, values, cb) { console.log('Model._insert');
  var forArrayMutator = true;
  segments = this._dereference(segments, forArrayMutator);
  var model = this;
...
Model.prototype.pop = function() { console.log('Model.pop');
  var subpath, cb;
  if (arguments.length === 1) {
    if (typeof arguments[0] === 'function') {
      cb = arguments[0];
...
Model.prototype._pop = function(segments, cb) { console.log('Model._pop');
  var forArrayMutator = true;
  segments = this._dereference(segments, forArrayMutator);
  var model = this;
...
Model.prototype.shift = function() { console.log('Model.shift');
  var subpath, cb;
  if (arguments.length === 1) {
    if (typeof arguments[0] === 'function') {
      cb = arguments[0];
...
Model.prototype._shift = function(segments, cb) { console.log('Model._shift');
  var forArrayMutator = true;
  segments = this._dereference(segments, forArrayMutator);
  var model = this;
...
Model.prototype.remove = function() { console.log('Model.remove');
...
Model.prototype._remove = function(segments, index, howMany, cb) { console.log('Model._remove');
  var forArrayMutator = true;
  segments = this._dereference(segments, forArrayMutator);
...
Model.prototype.move = function() { console.log('Model.move');
...
Model.prototype._move = function(segments, from, to, howMany, cb) { console.log('Model._move');
  var forArrayMutator = true;
  segments = this._dereference(segments, forArrayMutator);
  if (howMany == null) howMany = 1;
  var model = this;
...
Model.prototype.stringInsert = function() { console.log('Model.stringInsert');
...
Model.prototype._stringInsert = function(segments, index, text, cb) { console.log('Model._stringInsert');
  segments = this._dereference(segments);
  var model = this;
...
Model.prototype.stringRemove = function() { console.log('Model.stringRemove');
  var subpath, index, howMany, cb;
  if (arguments.length < 2) {
...
Model.prototype._stringRemove = function(segments, index, howMany, cb) { console.log('Model._stringRemove');
  segments = this._dereference(segments);
  var model = this;
...
Model.prototype.subtypeSubmit = function() { console.log('Model.subtypeSubmit');
...
Model.prototype._subtypeSubmit = function(segments, subtype, subtypeOp, cb) { console.log('Model._subtypeSubmit');
  segments = this._dereference(segments);
  var model = this;
