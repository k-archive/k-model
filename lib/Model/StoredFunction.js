...
Model.prototype.execute = function(fnName, params, cb) { console.log('Model.execute');
...
StoredFunction.prototype._flushSubscribeCallbacks = function(err, cb) { console.log('StoredFunction._flushSubscribeCallbacks');
  cb(err, this.get());
  var pendingCallback;
