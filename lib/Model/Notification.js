...
*/
Model.prototype.notification = function(collection, id, persistent) { console.log('Model.notification');
  var expression,
      options = {},
      notification;
...
Notification.prototype.add = function(data, cb) { console.log('Notification.add');
  var self = this,
      msg = {
        a: "nop",
...
Notification.prototype._setResults = function(results) { console.log('Notification._setResults');
  this._setResultIds(results);
};

Notification.prototype.get = function() { console.log('Notification.get');
...
Notification.prototype.ref = function(from) { console.log('Notification.ref');
  var idsPath = this.idsSegments.join('.');

  return this.model.refList(from, this.collectionName, idsPath, { idlist: true });
};

Notification.prototype._shareFetchedSubscribe = function(options, cb) { console.log('Notification._shareFetchedSubscribe');
...
Notification.prototype._shareSubscribe = function(options, cb) { console.log('Notification._shareSubscribe');
  var query = this;
...
Notification.prototype._getShareResults = function() { console.log('Notification._getShareResults');
