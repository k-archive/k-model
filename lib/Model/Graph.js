...
*/
Model.prototype._graphByRef = function(path) { console.log('Model._graphByRef');
...
Model.prototype.graph = function(graphName, options) { console.log('Model.graph');
  var expression,
      graph;
...
Graph.prototype._shareFetchedSubscribe = function(options, cb) { console.log('Graph._shareFetchedSubscribe');
...
**       data: <object>
*/
Graph.prototype.addEdge = function(from, to, data, cb) { console.log('Graph.addEdge');
...
**       data: <object>
*/
Graph.prototype.delEdge = function(from, to, data, cb) { console.log('Graph.delEdge');
...
Graph.prototype.delVertex = function(vertex, cb) { console.log('Graph.delVertex');
  this._doOp({ vertex: vertex, action: 'delvertex' }, cb);
};

Graph.prototype._doOp = function(op, cb) { console.log('Graph._doOp');
  var msg = {
        a: "gop",
        c: this.graphName,
        seq: undefined,
