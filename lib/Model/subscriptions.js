...
Model.prototype.rpc = function(name, params, cb) { console.log('Model.rpc');
...
Model.prototype.fetch = function() { console.log('Model.fetch');
  this._forSubscribable(arguments, 'fetch');
  return this;
};
Model.prototype.unfetch = function() { console.log('Model.unfetch');
  this._forSubscribable(arguments, 'unfetch');
  return this;
};
Model.prototype.subscribe = function() { console.log('Model.subscribe');
  this._forSubscribable(arguments, 'subscribe');
  return this;
};
Model.prototype.unsubscribe = function() { console.log('Model.unsubscribe');
  this._forSubscribable(arguments, 'unsubscribe');
  return this;
};

Model.prototype._forSubscribable = function(argumentsObject, method) { console.log('Model._forSubscribable');
  var args, cb;
...
Model.prototype.fetchDoc = function(collectionName, id, cb) { console.log('Model.fetchDoc');
...
Model.prototype.subscribeDoc = function(collectionName, id, cb, persistent) { console.log('Model.subscribeDoc');
  cb = this.wrapCallback(cb);
...
Model.prototype.unfetchDoc = function(collectionName, id, cb) { console.log('Model.unfetchDoc');
  cb = this.wrapCallback(cb);
...
Model.prototype.unsubscribeDoc = function(collectionName, id, cb, followPersistency) { console.log('Model.unsubscribeDoc');
  var model = this,
...
Model.prototype._maybeUnloadDoc = function(collectionName, id) { console.log('Model._maybeUnloadDoc');
...
Model.prototype._hasDocReferences = function(collectionName, id) { console.log('Model._hasDocReferences');
