...
Model.prototype.refList = function() { console.log('Model.refList');
...
RefList.prototype.get = function() { console.log('RefList.get');
...
RefList.prototype.dereference = function(segments, i) { console.log('RefList.dereference');
...
RefList.prototype.toSegmentsByItem = function(item) { console.log('RefList.toSegmentsByItem');
  var key = this.idByItem(item);
  if (key === undefined) return;
  return this.toSegments.concat(key);
};
RefList.prototype.idByItem = function(item) { console.log('RefList.idByItem');
...
RefList.prototype.indicesByItem = function(item) { console.log('RefList.indicesByItem');
...
RefList.prototype.itemById = function(id) { console.log('RefList.itemById');
  return this.model._get(this.toSegments.concat(id));
};
RefList.prototype.idByIndex = function(index) { console.log('RefList.idByIndex');
  return this.options.byid? index: this.model._get(this.idsSegments.concat(index));
};
RefList.prototype.onMutation = function(type, segments, eventArgs) { console.log('RefList.onMutation');
...
RefLists.prototype.add = function(refList) { console.log('RefLists.add');
  this.fromMap[refList.from] = refList;
};

RefLists.prototype.remove = function(from) { console.log('RefLists.remove');
  var refList = this.fromMap[from];
  delete this.fromMap[from];
  return refList;
};

RefLists.prototype.toJSON = function() { console.log('RefLists.toJSON');
  var out = [];
