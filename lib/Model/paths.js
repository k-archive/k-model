...
Model.prototype._splitPath = function(subpath) { console.log('Model._splitPath');
 ...
 * @api public
 */
Model.prototype.path = function(subpath) { console.log('Model.path');
...
Model.prototype.isPath = function(subpath) { console.log('Model.isPath');
  return this.path(subpath) != null;
};

Model.prototype.scope = function(path, persistent) { console.log('Model.scope');
 ...
 *  @api public
 */
Model.prototype.at = function(subpath, persistent) { console.log('Model.at');
  var path = this.path(subpath);
 ...
 * @return {Model} a scoped model
 */
Model.prototype.parent = function(levels) { console.log('Model.parent');
 ...
 * @return {String}
 */
Model.prototype.leaf = function(path) { console.log('Model.leaf');
