...
Model.prototype.setDiff = function() { console.log('Model.setDiff');
...
Model.prototype._setDiff = function(segments, value, cb) { console.log('Model._setDiff');
...
Model.prototype.setDiffDeep = function() { console.log('Model.setDiffDeep');
  var subpath, value, cb;
  if (arguments.length === 1) {
    value = arguments[0];
  } else if (arguments.length === 2) {
...
Model.prototype._setDiffDeep = function(segments, value, cb) { console.log('Model._setDiffDeep');
...
Model.prototype.setArrayDiff = function() { console.log('Model.setArrayDiff');
  var subpath, value, cb;
  if (arguments.length === 1) {
    value = arguments[0];
  } else if (arguments.length === 2) {
...
Model.prototype.setArrayDiffDeep = function() { console.log('Model.setArrayDiffDeep');
  var subpath, value, cb;
  if (arguments.length === 1) {
    value = arguments[0];
  } else if (arguments.length === 2) {
...
Model.prototype._setArrayDiffDeep = function(segments, value, cb) { console.log('Model._setArrayDiffDeep');
  return this._setArrayDiff(segments, value, cb, util.deepEqual);
};
Model.prototype._setArrayDiff = function(segments, value, cb, _equalFn) { console.log('Model._setArrayDiff');
  var before = this._get(segments);
...
Model.prototype._applyArrayDiff = function(segments, diff, cb) { console.log('Model._applyArrayDiff');
