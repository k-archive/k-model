...
RemoteDoc.prototype._initShareDoc = function() { console.log('RemoteDoc._initShareDoc');
  var doc = this;
...
RemoteDoc.prototype._updateCollectionData = function() { console.trace('RemoteDoc._updateCollectionData');
...
RemoteDoc.prototype.create = function(value, cb) { console.log('RemoteDoc.create');
...
RemoteDoc.prototype.set = function(segments, value, cb) { console.log('RemoteDoc.set');
  if (this.debugMutations) {
...
RemoteDoc.prototype.del = function(segments, cb) { console.log('RemoteDoc.del');
  if (this.debugMutations) {
...
RemoteDoc.prototype.increment = function(segments, byNumber, cb) { console.log('RemoteDoc.increment');
  if (this.debugMutations) {
...
RemoteDoc.prototype.push = function(segments, value, cb) { console.log('RemoteDoc.push');
  if (this.debugMutations) {
...
RemoteDoc.prototype.unshift = function(segments, value, cb) { console.log('RemoteDoc.unshift');
  if (this.debugMutations) {
...
RemoteDoc.prototype.insert = function(segments, index, values, cb) { console.log('RemoteDoc.insert');
  if (this.debugMutations) {
...
RemoteDoc.prototype.pop = function(segments, cb) { console.log('RemoteDoc.pop');
  if (this.debugMutations) {
...
RemoteDoc.prototype.shift = function(segments, cb) { console.log('RemoteDoc.shift');
  if (this.debugMutations) {
...
RemoteDoc.prototype.remove = function(segments, index, howMany, cb) { console.log('RemoteDoc.remove');
  if (this.debugMutations) {
...
RemoteDoc.prototype.move = function(segments, from, to, howMany, cb) { console.log('RemoteDoc.move');
  if (this.debugMutations) {
...
RemoteDoc.prototype.stringInsert = function(segments, index, value, cb) { console.log('RemoteDoc.stringInsert');
  if (this.debugMutations) {
...
RemoteDoc.prototype.stringRemove = function(segments, index, howMany, cb) { console.log('RemoteDoc.stringRemove');
  if (this.debugMutations) {
...
RemoteDoc.prototype.subtypeSubmit = function(segments, subtype, subtypeOp, cb) { console.log('RemoteDoc.subtypeSubmit');
  if (this.debugMutations) {
...
RemoteDoc.prototype.get = function(segments) { console.log('RemoteDoc.get');
  return util.lookup(segments, this.shareDoc.data);
};

RemoteDoc.prototype._createImplied = function(segments) { console.log('RemoteDoc._createImplied');
...
RemoteDoc.prototype._arrayApply = function(segments, fn, cb) { console.log('RemoteDoc._arrayApply');
...
RemoteDoc.prototype._onOp = function(op) { console.log('RemoteDoc._onOp');
  var item;
  if (op.length === 1) {
