...
var Backend = require('k-sync-debug').Backend;
...
RacerBackend.prototype.createModel = function(options, req) { console.log('RacerBackend.createModel');
...
RacerBackend.prototype.modelMiddleware = function() { console.log('RacerBackend.modelMiddleware');
  var backend = this;
